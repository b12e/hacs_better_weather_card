 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct=t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)},ht={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:_},lt=(t=ht,e,i)=>{const{kind:s,metadata:r}=i;let o=globalThis.litPropertyMetadata.get(r);if(void 0===o&&globalThis.litPropertyMetadata.set(r,o=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),o.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t){return dt({...t,state:!0,attribute:!1})}var ut,ft;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ut||(ut={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ft||(ft={}));var gt=function(t,e,i,s){s=s||{},i=null==i?{}:i;var r=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return r.detail=i,t.dispatchEvent(r),r};const mt={"clear-night":"mdi:weather-night",cloudy:"mdi:weather-cloudy",exceptional:"mdi:alert-circle-outline",fog:"mdi:weather-fog",hail:"mdi:weather-hail",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",partlycloudy:"mdi:weather-partly-cloudy",pouring:"mdi:weather-pouring",rainy:"mdi:weather-rainy",snowy:"mdi:weather-snowy","snowy-rainy":"mdi:weather-snowy-rainy",sunny:"mdi:weather-sunny",windy:"mdi:weather-windy","windy-variant":"mdi:weather-windy-variant"};console.info("%c  BETTER-WEATHER-CARD  \n%c  Version 1.0.0  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"better-weather-card",name:"Better Weather Card",description:"A beautiful weather card with Mushroom-inspired design"});let yt=class extends nt{constructor(){super(...arguments),this._forecast=[]}static async getConfigElement(){return await Promise.resolve().then(function(){return $t}),document.createElement("better-weather-card-editor")}static getStubConfig(){return{entity:"",show_current:!0,show_forecast:!0,forecast_days:5,layout:"compact"}}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}setConfig(t){this.config={show_current:!0,show_forecast:!0,forecast_days:5,layout:"compact",...t}}async _fetchForecast(){if(!this.hass||!this.config.entity)return[];try{const t=this.weatherEntity;if(t?.attributes?.forecast)return t.attributes.forecast;const e=await this.hass.callWS({type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:this.config.entity});return e?.forecast||[]}catch(t){return console.error("Error fetching forecast:",t),[]}}get weatherEntity(){return this.hass.states[this.config.entity]}getWeatherIcon(t){return mt[t]||"mdi:weather-cloudy"}formatTemperature(t){return`${Math.round(t)}°`}formatDay(t){const e=new Date(t),i=new Date,s=new Date(i);return s.setDate(s.getDate()+1),e.toDateString()===i.toDateString()?"Today":e.toDateString()===s.toDateString()?"Tomorrow":e.toLocaleDateString(void 0,{weekday:"short"})}handleAction(t){t&&gt(this,"hass-action",{config:this.config,action:t})}render(){if(!this.config||!this.hass)return I``;if(!this.config.entity)return I`
        <ha-card>
      ...
      `;const e="compact"===this.config.layout;return I`
      <ha-card>
    ...
    `}renderForecastAsync(){return this._fetchForecast().then(t=>{this._forecast=t.slice(0,this.config.forecast_days||5),this.requestUpdate()}),this.renderForecast(this._forecast||[])}renderCompactCurrent(t){const e=this.config.name||t.attributes.friendly_name||"Weather",i=t.state,s=t.attributes.temperature,r=t.attributes.humidity;return I`
    ...
    `}};t([dt({attribute:!1})],vt.prototype,"hass",void 0),t([pt()],vt.prototype,"config",void 0),vt=t([ct("better-weather-card-editor")],vt);var $t=Object.freeze({__proto__:null,get BetterWeatherCardEditor(){return vt}});export{yt as BetterWeatherCard};
